pipeline {
    ...
    stages {
        ...
        stage('AWS') {
            ...
            environment {
                AWS_S3_BUCKET = 'learn-jenkins-rafajcc'
            }
            steps {
                // Use AWS credentials defined in Jenkins. Code generated by Jenkins Pipeline Syntax helper 
                withCredentials([usernamePassword(credentialsId: 'AWS', passwordVariable: 'AWS_SECRET_ACCESS_KEY', usernameVariable: 'AWS_ACCESS_KEY_ID')]) {
                    sh '''
                        ...
                        ## upload/sync project folder 'build'
